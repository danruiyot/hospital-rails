...
class AdmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admission" do
    assert_difference('Admission.count') do
      post admissions_url, params: { admission: { date_released: @admission.date_released, doctor_id: @admission.doctor_id, patient_id: @admission.patient_id, ward_id: @admission.ward_id } }
    end
  ...
  test "should update admission" do
    patch admission_url(@admission), params: { admission: { date_released: @admission.date_released, doctor_id: @admission.doctor_id, patient_id: @admission.patient_id, ward_id: @admission.ward_id } }
