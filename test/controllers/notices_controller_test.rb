...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { expiry: @notice.expiry, message: @notice.message, start: @notice.start, target: @notice.target, title: @notice.title } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { expiry: @notice.expiry, message: @notice.message, start: @notice.start, target: @notice.target, title: @notice.title } }
